...
|----------------|---------------------------------------| ---- | ------- |
| targetLayer   | The first layer to monitor             | ``Object`` | `Required` |
...
A layer element (either targetLayer or secondElement) is an object that specifies the layer to monitor and can include filters to select only a subset of the layer.
```json
{
  "name": "layer1",
  "filter": {
